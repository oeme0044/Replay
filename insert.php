...
if (!empty($_POST["data"])) {
    ...
    if (!empty($file["tilbeImage"]["tmp_name"])) {
        move_uploaded_file($file["tilbeImage"]["tmp_name"], "uploads/" . basename($file["tilbeImage"]["name"]));
...
<div class="container mb-4 p-4 bg-dark bg-opacity-10 rounded-2 text-black ">
        ...
        <div class="row">
            <div class="col-12 col-md-5 mb-4">
                <div class="form-group">
                    <label for="tilbeNavn">Tilbehør Navn</label>
                    <input class="form-control" type="text" name="data[tilbeNavn]" id="tilbeNavn"
            ...
            <div class="col-12 col-md-5 mb-4">
                <div class="form-group">
                    <label for="tilbePrismrd">Pris pr. mrd i Kroner</label>
                    <input class="form-control" type="number" name="data[tilbePrismrd]" id="tilbePrismrd"
            ...
            <div class="col-12 col-md-5 mb-4">
                <div class="form-group">
                    <label for="tilbeStat1">Stat 1</label>
                    <input class="form-control" type="text" name="data[tilbeStat1]" id="tilbeStat1"
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="form-group">
                    <label for="tilbeStat2">Stat 2</label>
                    <input class="form-control" type="text" name="data[tilbeStat2]" id="tilbeStat2"
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="form-group">
                    <label for="tilbeStat3">Stat 3</label>
                    <input class="form-control" type="text" name="data[tilbeStat3]" id="tilbeStat3"
...
<div class="col-12">
    <label class="form-label" for="tilbeImage">Produkt Billede</label>
    <input type="file" class="form-control" id="tilbeImage" name="tilbeImage">
</div>
